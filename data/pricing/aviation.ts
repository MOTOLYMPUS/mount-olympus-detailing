...
// Warbird premium over the equivalent GA piston class: a 1.6× base for the
// extra labour, plus the owner's +30% warbird uplift (1.6 × 1.3 = 2.08).
const WARBIRD_FACTOR = 1.6 * 1.3;
...
const cls = (
  ...
  // Warbirds priced apart from GA piston aircraft — hand-polished bare-metal
  // skin, radial engine bays, fabric control surfaces, and concours
  // expectations. Rounded to the nearest $50 so every quote lands on a clean
  // number (00 or 50). PLACEHOLDER like the rest of this table until real
  // warbird pricing is set.
  'warbird-single': { price: round50(singlePiston * WARBIRD_FACTOR) },
  'warbird-twin': { price: round50(twinPiston * WARBIRD_FACTOR) },
});
...
export const aviationServices: ServiceDef[] = [
  ...
  },
  {
    ...
    // Warbird cells set to the owner's figures; other classes stay derived.
    prices: {
      ...cls(900, 1400, 2100, 2900, 4200, 6200, 1700),
      'warbird-single': { price: 2500 },
      'warbird-twin': { price: 3500 },
    },
  },
  {
    id: 'aviation-ceramic',
    ...
    // Warbird cells set to the owner's figures; other classes stay derived.
    prices: {
      ...cls(1400, 2200, 3300, 4500, 6500, 9500, 2600),
      'warbird-single': { price: 3500 },
      'warbird-twin': { price: 4500 },
    },
  },
  {
    id: 'aviation-cabin',
