...
export const automotiveServices: ServiceDef[] = [
  ...
  },
  {
    ...
    // Prices raised per owner: +$200 on coupe, sedan, 2-row SUV and small truck;
    // +$300 on 3-row SUV and full-size truck.
    prices: {
      coupe: { price: 500 }, // DERIVED from Sedan
      sedan: { price: 500 },
      'suv-2row': { price: 600 },
      'suv-3row': { price: 700 },
      'truck-small': { price: 600 },
      truck: { price: 700 },
    },
  },
