...
export type AviationSize =
  ...
  | 'heavy-jet'
  | 'helicopter'
  // Vintage military aircraft (P-51, T-28, T-6, B-25 …). Priced apart from GA
  // piston aircraft because the work is different: polished bare-metal skin,
  // radial engine bays, and museum-grade expectations.
  | 'warbird-single'
  | 'warbird-twin';
