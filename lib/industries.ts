...
export const industries: Record<Industry, IndustryConfig> = {
  ...
  aviation: {
    id: 'aviation',
    label: 'Aviation',
    tagline: 'Piston, turboprop, jets, warbirds & rotorcraft',
    ...
    vehicleTypes: [
      ...
      {
        id: 'warbird',
        label: 'Warbird / Military',
        catalog: 'aviation',
        sizes: ['warbird-single', 'warbird-twin'],
      },
    ...
    sizes: [
      ...
      { id: 'warbird-single', label: 'Single-Engine Warbird', hint: 'P-51, T-28, T-6, T-34, Stearman' },
      { id: 'warbird-twin', label: 'Multi-Engine Warbird', hint: 'B-25, A-26 and similar' },
