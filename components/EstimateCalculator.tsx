...
export default function EstimateCalculator({ onRequest }: Props) {
  ...
  return (
    // Visual pass only below this line. NOT ONE LINE of the pricing maths,
    // validation, or the `onRequest` payload above was touched — those are the
    // contract with lib/pricing.ts and with the API route that recomputes the
    // same numbers server-side.
    <section id="pricing" className="relative overflow-hidden bg-charcoal/40 py-20 sm:py-28">
      ...
      <div className="relative mx-auto max-w-[1400px] px-6 lg:px-10">
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr_420px] lg:gap-10">
          ...
          {/* Readout — the one panel on this page that earns a real
              backdrop-filter: a single sticky surface, not a repeated one. */}
          <div className="glass-panel gradient-border h-fit rounded-md p-6 shadow-card sm:p-8 lg:sticky lg:top-24">
