...
export function navFor(role: Role, counts: { messages?: number } = {}): NavItem[] {
  const customer: NavItem[] = [
    ...
    // Four tabs, not five: a fifth (the Advice page) made the bar too crowded
    // on a phone. Advice stays reachable from the home screen and the
    // long-press app shortcut instead.
